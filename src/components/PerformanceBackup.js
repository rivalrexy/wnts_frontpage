...
const Performance = (props) => {
  ...
  const renderMultiChart = (datas) => {
    ...
    datas.forEach(function (d) {
      ...
      d.DATE_STAMP = +d.DATE_STAMP; //parseDate(d.DATE_STAMP);
    ...
    var xScale = d3
      .scaleTime()
      .domain(d3.extent(datas[0], (d) => d.DATE_STAMP))
      .range([0, width - margin]);

    var yScale = d3
      .scaleLinear()
      .domain([0, d3.max(datas[0], (d) => d.VOLUME_RATE)])
